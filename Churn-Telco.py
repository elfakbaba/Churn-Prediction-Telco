...
df = pd.read_csv("elfakbaba/pythonprojects/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
...
# Looking at Monthly Chargers, customers with monthly contracts may pay more on average per month.
